...
export default function StationsPage() {
  ...
  const filteredStations = stations.filter((s) => cardFilter === 'ALL' || s.accepted_cards.includes(cardFilter));
    ...
    <main className="min-h-screen bg-slate-900 text-white p-6">
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          ...
          <div>
            <select
              ...
              className="bg-slate-800 border border-slate-700 rounded-lg p-2.5 text-sm text-white font-medium"
            >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="space-y-4">
            <h2 className="text-xl font-bold text-white flex items-center gap-2">
              🅿️ Parkeerterreinen & Bezettingsgraad
            </h2>
